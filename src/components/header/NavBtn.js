...
function NavBtn(props) {
    ...
    return (
        <button onClick={handleClick} className="nav-btn">
            ...
            <img className={`nav-btn-arrow ${dropState === title ? "nav-btn-arrow-rotate" : ""}`} src={require(`../../assets/images/${dropState === title ? "filled" : "unfilled" }-arrow.png`)} alt="arrow icon pointing down" />
        </button>
    )
}
